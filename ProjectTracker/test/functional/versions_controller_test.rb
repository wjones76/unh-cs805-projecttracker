...
class VersionsControllerTest < ActionController::TestCase
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post :create, version: { id: @version.id, project_id: @version.project_id, version_name: @version.version_name }
    end
  ...
  test "should update version" do
    put :update, id: @version, version: { id: @version.id, project_id: @version.project_id, version_name: @version.version_name }
    assert_redirected_to version_path(assigns(:version))
  end
