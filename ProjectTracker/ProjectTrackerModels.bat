...
rails generate scaffold project_task task_name:string{120} description:text project:references priority:references assigned_to:string{20} category:references start_date:date end_date:date version:string{20} status:references